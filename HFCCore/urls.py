...
urlpatterns = [
    ...
    path('centre/<hfc_center_slug>/signup/', views.CenterContributorSignup.as_view(), name='center_signup'),
    ...
    path('chapter/<hfc_chapter_slug>/signup/', views.ChapterContributorSignup.as_view(), name='chapter_signup'),
